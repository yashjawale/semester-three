...
while (flag == 1):
    ...
    if (choice == 1):
        ...
        print("Either cricket or badminton but not both: ", cobbnb(group_a, group_b))
        flag = 1 if askcontinue() else 0
    elif (choice == 3):
        print("No. of neither cricket nor badminton: ", no_ncnb(secomp, group_a, group_b))
        flag = 1 if askcontinue() else 0
    elif (choice == 4):
        print("No. of cricket and football but not badminton: ", no_cafbnb(group_a, group_b, group_c))
        flag = 1 if askcontinue() else 0
    else:
